...
export const blogArticles: BlogArticle[] = [
  {
    ...
    title: 'Coloring Pages: The Complete Creative Guide',
    description: 'Discover the ultimate guide to coloring pages - from benefits to techniques, for all ages and skill levels.',
    keywords: ['coloring pages', 'coloring guide', 'creative activities', 'art therapy'],
    category: 'guide',
  ...
  },
  {
    ...
    title: 'Christmas Coloring Pages: Holiday Magic in Every Stroke',
    description: 'Celebrate the holidays with festive Christmas coloring pages for all ages.',
    keywords: ['christmas coloring pages', 'holiday coloring', 'festive printables', 'winter activities'],
    category: 'seasonal',
