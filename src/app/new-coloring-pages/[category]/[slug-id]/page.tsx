...
interface NewColoringPagesDetailPageProps {
  params: Promise<{
    category: string;
    'slug-id': string;
  }>;
...
export async function generateMetadata({ params }: NewColoringPagesDetailPageProps) {
...
export default async function NewColoringPagesDetailPage({
  params
}: NewColoringPagesDetailPageProps) {
  // 等待params
