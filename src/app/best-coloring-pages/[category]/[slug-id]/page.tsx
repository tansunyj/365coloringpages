...
interface BestColoringPagesDetailPageProps {
  params: Promise<{
    category: string;
    'slug-id': string;
  }>;
...
/**
 * Best Coloring Pages 涂色卡片详情页
 * 使用统一的 SEO 生成系统 - 一次编写，多处使用！
 */
export async function generateMetadata({ params }: BestColoringPagesDetailPageProps) {
...
export default async function BestColoringPagesDetailPage({ params }: BestColoringPagesDetailPageProps) {
